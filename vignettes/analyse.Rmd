...
![Overline error example](./vignettes/images/analyse_overline_error.png)
...
```{r}
network = sf::st_read(system.file("extdata", "centerline_carris.gpkg", package = "GTFShift"), quiet = TRUE)
