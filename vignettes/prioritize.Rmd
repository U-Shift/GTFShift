...
```{r include=FALSE}
lanes = sf::st_read("https://github.com/U-Shift/GTFShift/releases/download/v0.8.0/prioritization_lisboa_rt_gtfs2026-02-04_run20260203.gpkg")
```
...
```{r include=FALSE}
lanes = sf::st_read("https://github.com/U-Shift/GTFShift/releases/download/v0.8.0/prioritization_lisboa_rt_gtfs2026-02-04_run20260203_extended.gpkg")
```
