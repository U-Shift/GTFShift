...
```{r include=FALSE}
frequencies_stop = sf::st_read("https://github.com/U-Shift/GTFShift/releases/download/v0.7.0/analyse_carris_stop_frequency_hourly.gpkg")
```
...
```{r include=FALSE}
frequencies_way = sf::st_read("https://github.com/U-Shift/GTFShift/releases/download/v0.7.0/analyse_carris_way_frequency_hourly.gpkg")
```
...
```{r include=FALSE}
frequencies_route = sf::st_read("https://github.com/U-Shift/GTFShift/releases/download/v0.7.0/analyse_carris_route_frequency_hourly.gpkg")
```
...
```{r include=FALSE}
frequencies_route_overline = sf::st_read("https://github.com/U-Shift/GTFShift/releases/download/v0.7.0/analyse_carris_route_frequency_hourly_overline.gpkg")
```
...
```{r include=FALSE}
frequencies_route_overline_improved = sf::st_read("https://github.com/U-Shift/GTFShift/releases/download/v0.7.0/analyse_carris_route_frequency_network_overline.gpkg")
```
