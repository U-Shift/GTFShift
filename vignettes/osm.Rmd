...
GTFS routes shapes and OSM bus routes are linked through OSM `gtfs:*` keys. `GTFShift::osm_shapes_to_routes()` allows to query OSM for the routes matching the feed trips, given their shape id.
