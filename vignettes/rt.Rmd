...
```{r include=FALSE}
lane_prioritization_extended = sf::st_read("https://github.com/U-Shift/GTFShift/releases/download/v0.8.0/prioritization_lisboa_rt_gtfs2026-02-04_run20260203_extended.gpkg")
```
...
mapview::mapview(
  ...
  zcol = "speed_avg",
  col.regions =  viridis::rocket(nrow(lane_prioritization_0800)),
