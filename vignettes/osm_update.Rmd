...
This example assumes that the steps described at [Matching shapes geometry]("./osm.html#matching-shapes-geometry") have been followed, up to the definition of the variable `shapes_match_routes`.
...
Load the data into Python environment, filtering the matches by the criteria that best suits your context.
```{python}
import pandas as pd
