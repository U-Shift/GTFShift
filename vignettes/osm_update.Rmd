...
> Permissions: `read_prefs` (Read user preferences), `write_api` (Modify the map), `write_notes` (Modify notes)
...
file_handler = logging.FileHandler(log_file_path) # Adjust the path as needed
