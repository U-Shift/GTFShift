...
df = pd.read_csv("../releases/v0_7_0/shapes_match_toulouse_gtfs20250802_run20250802.csv") # CSV with columns osm_id, shape_id and route_id (optional)
len(df)
...
file_handler = logging.FileHandler('../releases/v0_7_0/shapes_match_toulouse_gtfs20250802_run20250802.osm.log')
...
with api.Changeset({"comment": "Tisséo GTFS shapes and routes association (using GTFShift v0.7.0) II", "review_requested": "no", "locale": "pt", "source": "local knowledge"}) as changeset_id:
