...
area = "lisboa"
gtfs_date = "2026-04-20"
run_date = "20260421"
base_folder = "../../GTFShift-web/scripts/osm_match" 

df = pd.read_csv(f"{base_folder}/{area}/shapes_match_{area}_gtfs{gtfs_date}_run{run_date}.csv") # CSV with columns osm_id, shape_id and route_id (optional)
len(df)
...
```{python}
auth_code = "n5wuAkZn5OrzIJAkmxSoyxzu1koW-zAAG6yx3FAx3wc" # Replace with your authorization code
auth_code
