...
df = pd.read_csv("../releases/v0_7_0/shapes_match_toulouse_gtfs20250802_run20250802.csv") # CSV with columns oms_id, shape_id and osm_id (optional)
len(df)
...
... or the dev one. It is recommended to try to apply the changes first at the dev version, to avoid currupting the live OSM data.
```{python}
