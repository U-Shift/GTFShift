...
```{r}
# Load GTFS
gtfs_local <- GTFShift::download_feed("https://download.gtfs.de/germany/fv_free/latest.zip", "database/transit/germany_gtfs.zip")
...
```{r}
# Load GTFS
gtfs_local <- GTFShift::download_feed("https://gitlab.com/LACMTA/gtfs_rail/raw/master/gtfs_rail.zip", "database/transit/la_gtfs.zip")
...
gtfs_local <- GTFShift::download_feed(data[data$ID=="faro",]$URL, "database/transit/faro_gtfs.zip")
