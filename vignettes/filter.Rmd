...
```{r}
# Load GTFS
gtfs <- GTFShift::download_feed("https://download.gtfs.de/germany/fv_free/latest.zip")
summary(gtfs)
```
...
```{r}
# Load GTFS
gtfs <- GTFShift::download_feed("https://gitlab.com/LACMTA/gtfs_rail/raw/master/gtfs_rail.zip")
summary(gtfs)
```
...
gtfs <- GTFShift::download_feed(data[data$ID=="faro",]$URL)
summary(gtfs)
```
