...
feeds = GTFShift::query_mobilitydatabase(refresh_token = Sys.getenv("MOBILITY_DATABASE"),
                                         subdivision_name = "Lisbon")
...
gtfs = GTFShift::load_feed(feeds$producer_url[1])
summary(gtfs)
```
...
gtfs = GTFShift::load_feed(data$URL[1], # example with CP - trains
