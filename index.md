...
It provides a simple bundle for an aggregated analysis, that with one
execution compiles in a few seconds the following indicators:
...
> considering road segments with a minimum frequency of 5 buses/hour and
> more than 1 lane per direction.
...
![](reference/figures/analyse_aggregated_frequencies.png)
...
![](reference/figures/osm_buslanes.png)
