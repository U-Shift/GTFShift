# Prioritise bus lane implementation
...
- [`GTFShift::rt_collect_json()`](https://u-shift.github.io/GTFShift/reference/rt_collect_json.md)
  ...
  to include real-time operational metrics in the prioritisation
  analysis.

This document explores how to use these methods in a combined way to
assist public transport planners in prioritising bus lane
...
prioritisation analysis with real-time operational metrics, such as
...
details on how to collect GTFS-RT data and extend the prioritisation
analysis.

### Analyze results

Method
[`GTFShift::get_prioritisation_stats()`](https://u-shift.github.io/GTFShift/reference/get_prioritisation_stats.md)
can be used to obtain statistics about lane prioritisation, weighted by
...
prioritisation criteria defined by the user. For instance, the following
...
enabling the identification and eventual prioritisation of critical
